...
export const defaultShortcuts = [
    {
        text: '今天',
        value: () => {
            const start = beginOfDay(new Date())
    ...
    },
    {
        text: '昨天',
        value: () => {
            const start = beginOfDay(offsetDay(new Date(), -1));
            const end = endOfDay(offsetDay(new Date(), -1))
            return [start, end]
        },
    },
    {
        text: '最近七天',
        value: () => {
            const start = beginOfDay(offsetDay(new Date(), -6));
            const end = endOfDay(offsetDay(new Date(), -0))
            return [start, end]
        },
    },
    {
        text: '最近 30 天',
        value: () => {
            const start = beginOfDay(offsetDay(new Date(), -29));
            const end = endOfDay(offsetDay(new Date(), -0))
            return [start, end]
        },
    },
    {
        text: '本月',
        value: () => {
            const start = beginOfMonth(new Date(),);
    ...
    },
    {
        text: '上月',
        value: () => {
            const start = beginOfMonth(offsetMonth(new Date(), -1));
            const end = endOfMonth(offsetMonth(new Date(), -1))
            return [start, end]
        },
    },
    {
 ...
 * @returns {string} 字符串
 */
export function formatPast2(ms: any) {
 ...
 * @returns  传入时间的开始时间
 */
export function beginOfMonth(param: Date) {
    return dayjs(param).startOf('month').toDate()
}
 ...
 * @returns  传入时间的结束时间
 */
export function endOfMonth(param: Date) {
    return dayjs(param).endOf('month').toDate()
}
...
export function offsetDay(date: Date, offset: number): Date|undefined {
    if (date === undefined) {
        return undefined;
    }
...
export function offsetMonth(date: Date, offset: number): Date |undefined{
    if (date === undefined) {
        return undefined;
    }
    return dayjs(date).add(offset, 'month').toDate();
}
